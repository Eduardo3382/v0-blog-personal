    ...
    return (
        <section className="py-12 px-6 md:px-12 lg:px-24 bg-background">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-[1fr_1.5fr] gap-12 items-center bg-card/30 rounded-3xl p-8 border border-border/50 backdrop-blur-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-4">
                            <Link
                                href={`mailto:eduardo.h.delafuente@outlook.com?subject=Inscripción a ${workshop.title}&body=${encodeURIComponent(
